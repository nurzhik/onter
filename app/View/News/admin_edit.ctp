      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          <div class="form-group">
              <label for="selectRegion">Тип :</label>
              <select name="data[News][type]"  id="selectRegion" class="form-control custom-select">
                <option value="news" <?=  ($data['News']['type']  == 'news') ? 'selected' : '' ?> >Новости</option>
                <option value="smi" <?=  ($data['News']['type']  == 'smi') ? 'selected' : '' ?>>СМИ</option>
          ...
          <div class="form-group">
            <label for="short_desc">Кратки текст</label>
            <textarea id="short_desc" class="form-control"  name="data[News][short_desc]" ><?=$data['News']['short_desc']?></textarea>
          </div>
    			<div class="form-group">
